...
Public Class GetSSLExpirationDateForm
    ...
    Private Function GetSSLExpirationDate(ByVal url As String) As String
        ...
        Dim expiryDate As DateTime = sp.Certificate.GetExpirationDateString()
        Return expiryDate.ToLongDateString + " " + expiryDate.ToLongTimeString
